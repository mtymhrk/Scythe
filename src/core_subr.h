...
int scm_subr_func_null_P(int argc, const ScmObj *argv);
...
int scm_subr_func_cons(int argc, const ScmObj *argv);
int scm_subr_func_car(int argc, const ScmObj *argv);
int scm_subr_func_cdr(int argc, const ScmObj *argv);
...
int scm_subr_func_read(int argc, const ScmObj *argv);
int scm_subr_func_write(int argc, const ScmObj *argv);
int scm_subr_func_display(int argc, const ScmObj *argv);
int scm_subr_func_newline(int argc, const ScmObj *argv);
int scm_subr_func_flush_output_port(int argc, const ScmObj *argv);
...
int scm_subr_func_callcc(int argc, const ScmObj *argv);
...
int scm_subr_func_values(int argc, const ScmObj *argv);
...
int scm_subr_func_eval_asm(int argc, const ScmObj *argv);
int scm_subr_func_eval(int argc, const ScmObj *argv);
...
int scm_subr_func_exit(int argc, const ScmObj *argv);
...
int scm_subr_func_default_exception_handler(int argc, const ScmObj *argv);
