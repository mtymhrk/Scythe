...
ScmObj scm_api_memq(ScmObj obj, ScmObj lst);
ScmObj scm_api_memv(ScmObj obj, ScmObj lst);
ScmObj scm_capi_member(ScmObj obj, ScmObj lst,
                       ScmObj (*cmp)(ScmObj x, ScmObj y));
ScmObj scm_api_assq(ScmObj obj, ScmObj alist);
ScmObj scm_api_assv(ScmObj obj, ScmObj alist);
...
ScmObj scm_api_string_append_lst(ScmObj lst);
...
ScmObj scm_api_vector_copy_i(ScmObj to, ScmObj at,
                             ScmObj from, ScmObj start, ScmObj end);
ScmObj scm_api_vector_append_lst(ScmObj lst);
...
bool scm_capi_bytevector_p(ScmObj obj);
ScmObj scm_api_bytevector_P(ScmObj obj);
...
ScmObj scm_capi_open_binary_input_fd(int fd);
ScmObj scm_capi_open_output_fd(int fd, const char *enc);
ScmObj scm_capi_open_binary_output_fd(int fd);
ScmObj scm_capi_open_input_file(const char *path, const char *enc);
ScmObj scm_capi_open_binary_input_file(const char *path);
...
ScmObj scm_capi_open_binary_output_file(const char *path);
...
ScmObj scm_capi_open_input_bytevector_cbytes(const void *bytes, size_t size);
ScmObj scm_api_open_input_bytevector(ScmObj vec);
ScmObj scm_api_open_output_bytevector(void);
ScmObj scm_api_get_output_bytevector(ScmObj port);
off_t scm_capi_port_seek(ScmObj port, off_t offset, int whence);
...
int scm_capi_write_cbytes(const void *bytes, size_t size, ScmObj port);
...
ScmObj scm_api_closure_to_iseq(ScmObj clsr);
...
ScmObj scm_api_parameter_value(ScmObj prm);
...
const size_t *scm_capi_iseq_br_dsts(ScmObj iseq);
...
ScmObj scm_api_capture_cont(void);
bool scm_capi_continuation_p(ScmObj obj);
ScmObj scm_api_cont_capture_obj(ScmObj cont);
