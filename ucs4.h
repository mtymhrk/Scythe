...
Ucs4String *ucs4str_from_utf8(const void *utf8);
...
Ucs4String *ucs4str_append_utf8(Ucs4String *str, const void *append);
...
int ucs4str_match_utf8(const Ucs4String *str, const void *utf8_pat);
ssize_t ucs4str_to_ascii(const Ucs4String *str, char *ascii, size_t size);
ssize_t ucs4str_to_utf8(const Ucs4String *str, void *utf8, size_t size);
