...
test_scm_string_is_equal_compare_with_same_string_ucs4(void)
{
  ...
  str1 = scm_string_construct(row, row_len, SCM_ENCODING_UCS4);
  str2 = scm_string_construct(row, row_len, SCM_ENCODING_UCS4);
...
test_scm_string_is_equal_compare_with_different_string_ucs4(void)
{
  ...
  str1 = scm_string_construct(row1, row1_len, SCM_ENCODING_UCS4);
  str2 = scm_string_construct(row2, row2_len, SCM_ENCODING_UCS4);
...
test_scm_string_substr_ucs4(void)
{
  ...
  str = scm_string_construct(row, row_len, SCM_ENCODING_UCS4);
...
test_scm_string_append_ucs4(void)
{
  ...
  str = scm_string_construct(row1, row1_len, SCM_ENCODING_UCS4);
  apnd = scm_string_construct(row2, row2_len, SCM_ENCODING_UCS4);
...
test_scm_string_match_matched_ucs4(void)
{
  ...
  str = scm_string_construct(row1, row1_len, SCM_ENCODING_UCS4);
  pat = scm_string_construct(row2, row2_len, SCM_ENCODING_UCS4);
