...
TEST(api_fixnum, capi_fixnum_p__return_true)
{
...
TEST(api_fixnum, capi_fixnum_p__return_false_1)
{
  TEST_ASSERT_FALSE(scm_capi_fixnum_p(SCM_TRUE_OBJ));
}

TEST(api_fixnum, capi_fixnum_p__return_false_2)
{
  TEST_ASSERT_FALSE(scm_capi_fixnum_p(SCM_OBJ_NULL));
}

TEST(api_fixnum, api_fixnum_P__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, api_fixnum_P__return_false)
{
...
TEST(api_fixnum, capi_complex_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_real_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_rational_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_integer_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_exact_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_inexact_p__return_false)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_exact_integer_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_finite_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_infinite_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_nan_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_num_eq__return_true)
{
...
TEST(api_fixnum, capi_num_eq__return_false)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_eq__transitive)
{
...
TEST(api_fixnum, capi_num_lt__equal)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_lt__greater)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_lt__transitive)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT, fn3 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_gt__equal)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_gt__greater)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_gt__transitive)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT, fn3 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_le__less)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_le__equal)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_le__greater)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_le__transitive)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT, fn3 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_ge__equal)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_ge__greater)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_num_ge__transitive)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT, fn3 = SCM_OBJ_INIT;
  bool actual;
...
TEST(api_fixnum, capi_zero_p__return_false)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_positive_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_positive_p__return_false)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_negative_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_negative_p__return_false)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_odd_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_odd_p__return_false)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_even_p__return_true)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, capi_even_p__return_false)
{
  ScmObj fn = SCM_OBJ_INIT;
...
TEST(api_fixnum, api_max__first)
{
...
TEST(api_fixnum, api_max__second)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(api_fixnum, api_min__first)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(api_fixnum, api_min__second)
{
  ScmObj fn1 = SCM_OBJ_INIT, fn2 = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(api_fixnum, api_abs__positive)
{
...
TEST(api_fixnum, api_abs__negative_1)
{
...
TEST(api_fixnum, api_abs__negative_2)
{
  ScmObj fn = SCM_OBJ_INIT, expected = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
