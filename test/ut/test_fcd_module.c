...
make_syntax(const char *k)
{
  ...
  syntax = scm_fcd_make_syntax(key, SCM_NIL_OBJ);
}
...
get_gloc(const char *n)
{
  ...
  symbol = scm_fcd_make_symbol_from_cstr(n, SCM_ENC_ASCII);
  gloc = scm_fcd_get_gloc(module, symbol);
}
...
find_gloc(const char *n)
{
  ...
  symbol = scm_fcd_make_symbol_from_cstr(n, SCM_ENC_ASCII);
  scm_fcd_find_gloc(module, symbol, SCM_CSETTER_L(gloc));
}

TEST(fcd_module, make_module)
{
  make_module("test");

  TEST_ASSERT_TRUE(scm_fcd_module_p(module));
  TEST_ASSERT_TRUE(scm_fcd_true_p(scm_fcd_equal_P(name,
                                                  scm_fcd_module_name(module))));
}

TEST(fcd_module, make_module__already_exist)
{
  make_module("main");
...
TEST(fcd_module, find_module__not_exist)
{
  find_module("test");
...
TEST(fcd_module, find_gloc__not_exist)
{
...
TEST(fcd_module, define_global_var)
{
  ...
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_define_global_var(module, sym, val, false));
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_global_var_ref(module,
                                                  sym, SCM_CSETTER_L(actual)));
  TEST_ASSERT_SCM_EQ(val, actual);
}

TEST(fcd_module, define_global_var__already_bound)
{
  ...
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_define_global_var(module,
                                                     sym, val1, false));
...
TEST(fcd_module, global_var_ref__unbound)
{
...
TEST(fcd_module, global_var_ref__refer_exported_symbol_of_imported_module)
{
  ScmObj sym = SCM_OBJ_INIT, val = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
  ...
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_define_global_var(module, sym, val, true));
...
TEST(fcd_module, global_var_ref__refer_unexported_symbol_of_imported_module)
{
  ScmObj sym = SCM_OBJ_INIT, val = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(fcd_module, global_var_ref__refer_exported_symbol_of_imported_module__restrictive)
{
  ScmObj sym = SCM_OBJ_INIT, val = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(fcd_module, global_var_ref__refer_exported_symbol_of_imported_module__restrictive__2)
{
  ScmObj sym = SCM_OBJ_INIT, val = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(fcd_module, define_global_syx)
{
  ...
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_define_global_syx(module, sym, syx, false));
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_global_syx_ref(module,
                                                  sym, SCM_CSETTER_L(actual)));
  TEST_ASSERT_SCM_EQ(syx, actual);
}

TEST(fcd_module, define_global_syx__already_bound)
{
  ...
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_define_global_syx(module, sym, syx1, false));

  TEST_ASSERT_EQUAL_INT(0, scm_fcd_define_global_syx(module, sym, syx2, false));
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_global_syx_ref(module,
                                                  sym, SCM_CSETTER_L(actual)));
  TEST_ASSERT_SCM_EQ(syx2, actual);
}

TEST(fcd_module, global_syx_ref__unbound)
{
  ScmObj sym = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(fcd_module, global_syx_ref__refer_exported_symbol_of_imported_module)
{
  ScmObj sym = SCM_OBJ_INIT, syx = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
  ...
  TEST_ASSERT_EQUAL_INT(0, scm_fcd_define_global_syx(module, sym, syx, true));
...
TEST(fcd_module, global_syx_ref__refer_unexported_symbol_of_imported_module)
{
  ScmObj sym = SCM_OBJ_INIT, syx = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(fcd_module, global_syx_ref__refer_exported_symbol_of_imported_module__restrictive)
{
  ScmObj sym = SCM_OBJ_INIT, syx = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
...
TEST(fcd_module, global_syx_ref__refer_exported_symbol_of_imported_module__restrictive_2)
{
  ScmObj sym = SCM_OBJ_INIT, syx = SCM_OBJ_INIT, actual = SCM_OBJ_INIT;
