...
TEST(vectors, capi_vector_p__return_false_1)
{
  TEST_ASSERT_FALSE(scm_capi_vector_p(SCM_EOF_OBJ));
}

TEST(vectors, capi_vector_p__return_false_2)
{
  TEST_ASSERT_FALSE(scm_capi_vector_p(SCM_OBJ_NULL));
}

TEST(vectors, api_vector_P__return_true)
{
  ScmObj vec = SCM_OBJ_INIT;
...
TEST(vectors, capi_make_vector__specify_fill)
{
...
TEST(vectors, capi_vector_length__return_ERROR)
{
  TEST_ASSERT_EQUAL_INT(-1, scm_capi_vector_length(SCM_TRUE_OBJ));
}

TEST(vectors, api_vector_length)
{
...
TEST(vectors, capi_vector_set_i__set_SCM_OBJ_NULL__return_ERROR)
{
  ScmObj vec = SCM_OBJ_INIT, elm = SCM_OBJ_INIT;
...
TEST(vectors, capi_vector_set_i__return_ERROR)
{
  ScmObj elm = SCM_OBJ_INIT;
...
TEST(vectors, api_vector_copy_i__unspecify_start_end)
{
  ScmObj to = SCM_OBJ_INIT, from = SCM_OBJ_INIT, expected = SCM_OBJ_INIT;
