...
test_scm_integer_new(void)
{
  ...
  integer = scm_integer_new(SCM_CAPI_MEM_HEAP, 0LL);
...
test_scm_integer_value(void)
{
  ...
  integer = scm_integer_new(SCM_CAPI_MEM_HEAP, 100LL);
...
test_scm_integer_plus(void)
{
  ...
  integer1 = scm_integer_new(SCM_CAPI_MEM_HEAP, 200LL);
  integer2 = scm_integer_new(SCM_CAPI_MEM_HEAP, 100LL);
...
test_scm_integer_reminder(void)
{
  ...
  integer1 = scm_integer_new(SCM_CAPI_MEM_HEAP, 200LL);
  integer2 = scm_integer_new(SCM_CAPI_MEM_HEAP, 3LL);
