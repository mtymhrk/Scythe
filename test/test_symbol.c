...
test_scm_symbol_construct(void)
{
  ...
  /* preprocess */
  SCM_SETQ(str,
           scm_string_construct("foo", sizeof("foo") - 1, SCM_ENCODING_ASCII));

  /* action */
  SCM_SETQ(sym, scm_symbol_construct(str));
...
test_scm_symbol_instance__2_symbols_derived_from_same_string_shuld_be_same_instance(void)
{
  ...
  /* preprocess */
  SCM_SETQ(str,
           scm_string_construct("bar", sizeof("bar") - 1, SCM_ENCODING_ASCII));
...
test_scm_symbol_string__string_derived_from_a_symbol_should_be_equal_to_the_string_from_which_the_symbol_was_derived(void)
{
  ...
  /* preprocess */
  SCM_SETQ(expected,
           scm_string_construct("baz", sizeof("baz") - 1, SCM_ENCODING_ASCII));
