...
void
test_scm_api_compile__refer_global_variable(void)
{
  ScmObj exp = SCM_OBJ_INIT, port = SCM_OBJ_INIT;
  ScmObj actual = SCM_OBJ_INIT, expected = SCM_OBJ_INIT;
...
void
test_scm_api_compile__refer_bound_variable(void)
{
  ScmObj exp = SCM_OBJ_INIT, port = SCM_OBJ_INIT;
  ScmObj actual = SCM_OBJ_INIT, expected = SCM_OBJ_INIT;
  const char *exp_str = "(lambda (v1 v2) v2)";
  const char *asm_str = "((asm-close 0 ((sref 1)(return 2)))(return 0))";
