...
ScmObj scm_string_construct(SCM_MEM_ALLOC_TYPE_T mtype,
                            const void *src, size_t size, SCM_ENCODING_T enc);
...
ScmObj scm_string_substr(ScmObj str, unsigned int pos, size_t len);
ScmObj scm_string_push(ScmObj str, const scm_char_t c);
ScmObj scm_string_append(ScmObj str, ScmObj append);
scm_char_t scm_string_ref(ScmObj str, unsigned int pos);
ScmObj scm_string_set(ScmObj str, unsigned int pos, const scm_char_t c);
ScmObj scm_string_fill(ScmObj str, unsigned int pos, size_t len, scm_char_t c);
int scm_string_find_chr(ScmObj str, scm_char_t c);
int scm_string_match(ScmObj str, ScmObj pat);
