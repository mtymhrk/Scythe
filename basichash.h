...
typedef enum {
  SCM_BASIC_HASH_ITR_BLK_SUCC,
  SCM_BASIC_HASH_ITR_BLK_DELETE,
  SCM_BASIC_HASH_ITR_BLK_BREAK
} SCM_BASIC_HASH_ITR_BLK_RET_T;
...
typedef SCM_BASIC_HASH_ITR_BLK_RET_T (*ScmBasicHashIterBlock)(ScmBasicHashEntry *entry);
